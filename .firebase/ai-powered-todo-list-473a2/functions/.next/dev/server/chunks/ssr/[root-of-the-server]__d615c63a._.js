...
const taskService = {
    // Add a new task
    addTask: async (task, userId = 'demo-user')=>{
        try {
    ...
    getTasks: async (userId = 'demo-user')=>{
        try {
...
"[project]/Desktop/ai-powered-todo-list/actions/data:76b210 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$ai$2d$powered$2d$todo$2d$list$2f$actions$2f$data$3a$76b210__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/Desktop/ai-powered-todo-list/actions/data:76b210 [app-ssr] (ecmascript) <text/javascript>");
...
function TaskList() {
    ...
    const loadTasks = async ()=>{
        try {
            const fetchedTasks = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$ai$2d$powered$2d$todo$2d$list$2f$services$2f$taskService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["taskService"].getTasks();
    ...
    const handleAddTask = async (title, isAi)=>{
        ...
        if (isAi) {
            setLoading(true);
            try {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$ai$2d$powered$2d$todo$2d$list$2f$actions$2f$data$3a$76b210__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["parseTaskAction"])(title);
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$ai$2d$powered$2d$todo$2d$list$2f$services$2f$taskService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["taskService"].addTask(taskData);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d615c63a._.js.map