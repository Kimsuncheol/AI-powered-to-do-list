...
;
;
const AgentChat = /*#__PURE__*/ _s((0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$ai$2d$powered$2d$todo$2d$list$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(_c = _s(({ onTasksChanged }, ref)=>{
    _s();
    ...
    const handleSend = async (messageContent)=>{
        ...
        setLoading(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$ai$2d$powered$2d$todo$2d$list$2f$actions$2f$data$3a$5e5dcc__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["runAgentAction"])(textToSend, user.uid, messages);
            if (result.success) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$ai$2d$powered$2d$todo$2d$list$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useImperativeHandle"])(ref, {
        "AgentChat.useImperativeHandle": ()=>({
                sendMessage: ({
                    "AgentChat.useImperativeHandle": (message)=>{
                        handleSend(message);
                    }
                })["AgentChat.useImperativeHandle"]
            })
...
}, "h2p+xqymA8UQ7TxhjemTMmssjyI=", false, function() {
    return [
...
const __TURBOPACK__default__export__ = AgentChat;
var _c, _c1;
__turbopack_context__.k.register(_c, "AgentChat$forwardRef");
__turbopack_context__.k.register(_c1, "AgentChat");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function TaskList() {
    ...
    const agentChatRef = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$ai$2d$powered$2d$todo$2d$list$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useRef(null);
    ...
    const handleAddTask = async (title, isAi)=>{
        ...
        if (isAi) {
            if (agentChatRef.current) {
                agentChatRef.current.sendMessage(title);
            }
            return;
        }
        try {
...
_s(TaskList, "BZ+1xWP78p2gz0gcjx4EgHP0J+8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$ai$2d$powered$2d$todo$2d$list$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=Desktop_ai-powered-todo-list_3475a164._.js.map